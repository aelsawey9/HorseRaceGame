...
class AnimalPanel extends JPanel implements ActionListener, ChangeListener {
    ...
    public void setButtonIcons() {
        ...
        horseButton.addChangeListener(this);
        ...
        turtleButton.addChangeListener(this);
        ...
        rabbitButton.addChangeListener(this);
        ...
        cheetahButton.addChangeListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == this.enterNames) {
            if (!this.animalNameField.getText().equals(new String("")) && !this.playerNameField.getText().equals(new String("")) && selectedOneAnimal == true) {
    ...
    private void animalSelectedPanel() {
        ...
        if (selectedOneAnimal == true && !this.animalNameField.getText().equals("") && !this.playerNameField.getText().equals("")) {
            gc.gridx = 0;
            gc.gridy = 0;
